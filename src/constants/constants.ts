...
export const POLISH_BANKS = [
  ...
  export const POLISH_BANKS_LOGOS_COLORS_DARK_MODE: PolishBankLogosColors = {
    "PKO Bank Polski": { logo: "https://s3-symbol-logo.tradingview.com/pkobp--600.png", backgroundColor: 'rgba(2, 66, 131, 0.5)', borderColor: 'rgba(2, 66, 131, 0.6)' },
    "Bank Pekao SA": { logo: "https://yt3.googleusercontent.com/wjqeMBJLJ9pdL_QcdZwTjIhzSQ3UPsLKAie9DM93Zd_VwXLDWlMA2lsBaCiZnNAl9JW9kw0lCto=s900-c-k-c0x00ffffff-no-rj", backgroundColor: 'rgba(217, 48, 60, 0.7)', borderColor: 'rgba(217, 48, 60, 0.8)' },
    "mBank": { logo: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQp0zeuqJb2XcCgb3nuo-2XmZY7z8POc-wQrGCWnPdQaA&s', backgroundColor: 'rgba(231, 2, 22, 0.5)', borderColor: 'rgba(231, 2, 22, 0.6)' },
    "ING Bank Śląski": { logo: "https://www.galeriapolnocna.pl/cache/_store/ing-bank-slaski_main.jpeg_alpha-0_nc_366x366_im.webp", backgroundColor: 'rgba(232, 108, 38, 0.5)', borderColor: 'rgba(232, 108, 38, 0.6)' },
    "Bank Millennium": { logo: "https://yt3.googleusercontent.com/ytc/AIdro_nh2v2q8pV6-q5zU92rNVRkSzxSMwG2D5JqhCLdTg=s900-c-k-c0x00ffffff-no-rj", backgroundColor: 'rgba(205, 7, 108, 0.6)', borderColor: 'rgba(205, 7, 108, 0.7)' },
    "Alior Bank": { logo: "https://iconape.com/wp-content/files/uh/209497/png/209497.png", backgroundColor: 'rgba(108, 23, 22, 0.5)', borderColor: 'rgba(108, 23, 22, 0.6)' },
    "Santander Bank Polska": { logo: "https://www.santander.pl/_fileserver/time20221223125626/item/1514567", backgroundColor: 'rgba(209, 0, 13, 0.6)', borderColor: 'rgba(209, 0, 13, 0.7)' },
    "VeloBank": { logo: "https://prnews.pl/wp-content/uploads/2022/11/VeloBank_logo-e1669095277904.png", backgroundColor: 'rgba(25, 175, 77, 0.5)', borderColor: 'rgba(25, 175, 77, 0.6)' },
    "Credit Agricole Bank Polska": { logo: "https://icons.veryicon.com/png/o/business/bank-logo-collection/logo-of-credit-agricole.png", backgroundColor: 'rgba(21, 123, 116, 0.6)', borderColor: 'rgba(21, 123, 116, 0.7)' },
    "Raiffeisen Digital": { logo: "https://play-lh.googleusercontent.com/sWe4Dh2Z7Uxkdka9L07mQkGsu5ncH8BwCCCYVYjOLpOjbMz8YWNfyddM_oINkp3ZHKI", backgroundColor: 'rgba(255, 231, 58, 0.5)', borderColor: 'rgba(255, 231, 58, 0.6)' },
    "BNP Paribas Bank Polska": { logo: "https://p7.hiclipart.com/preview/209/419/819/5bfad0c24e8e5.jpg", backgroundColor: 'rgba(22, 176, 117, 0.7)', borderColor: 'rgba(22, 176, 117, 0.8)' },
    "Bank Pocztowy": { logo: "https://grubber.gpcdn.pl/companies/3333867/employer-profile-logos/2da80000-56be-0050-9e61-08dc01686915.jpg", backgroundColor: 'rgba(64, 22, 99, 0.6)', borderColor: 'rgba(64, 22, 99, 0.7)' },
  };
  
 
  export const POLISH_BANKS_LOGOS_COLORS_DARK_MODE_ARR = Object.entries(POLISH_BANKS_LOGOS_COLORS_DARK_MODE)
