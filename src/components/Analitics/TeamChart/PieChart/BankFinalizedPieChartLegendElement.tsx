...
type BankFinalizedPieChartLegendElementProps = {
  ...
  export const BankFinalizedPieChartLegendElement= ({ settings }: BankFinalizedPieChartLegendElementProps) => {
    const { label, obj, value } = settings;
    return (
      <Flex key={label} alignItems={'center'} fontSize={'10px'} gap='10px' justifyContent={"space-between"}>
