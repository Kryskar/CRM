...
import { LogoYoutube } from '../components/Misc/LogoYoutube';

const handleRedirect = () => {
  window.open('https://www.youtube.com/watch?v=hKdOYG5AjKk', '_blank', 'noopener,noreferrer');
};
/* eslint-disable */
export const getSteps = (email: string) => {
  const isDemoVersion = email === 'mycrmtestuser@gmail.com';
  ...
  const steps: Step[] = [
    {
      ...
      content: (
        <Flex flexDirection='column' gap='10px'>
          <Heading size='h4'>
            Welcome to the {isDemoVersion ? 'demo' : 'full'} version of CRM application!
          </Heading>
          <Text>
    ...
    },
    {
      ...
      content: (
        <Text>
          ...
          because they are the highest priority. Agent's task is to contact the client and update
    ...
    },
    {
      ...
      content: (
        <Text>
          Every status change creates or modifies a calendar event. These events can be viewed in
          the <chakra.span fontWeight={500}>Calendar</chakra.span> tab.
        </Text>
      ),
    },
    {
      ...
      content: (
        <Text textAlign={'center'}>
          {isDemoVersion ? (
            <>
              This is our <chakra.span fontWeight={500}>Calendar</chakra.span> component. <br />
              <br />
              In the full version of the application, it is integrated with{' '}
            </>
          ) : (
            <>
              This is our <chakra.span fontWeight={500}>Calendar</chakra.span> component, fully
              integrated with{' '}
            </>
          )}
          ...
          <chakra.span>
            <Flex
              ...
              mt='20px'
            >
              <Text>you can check presentation video:</Text>
              <Button
                alignItems={'center'}
                borderRadius='md'
                border='1px'
                ...
                onClick={handleRedirect}
              >
                <LogoYoutube /> <Text fontWeight={500}>Google Calendar integration demo</Text>
              </Button>
            </Flex>
          </chakra.span>
        </Text>
    ...
    },
    {
      ...
      content: (
        <Text>
          ...
          <chakra.span fontWeight={500}>"Finalized"</chakra.span> tab, where all completed clients
          are listed.
        </Text>
      ),
      placement: 'center',
    },
    {
      ...
      content: (
        <Text>
          ...
          <chakra.span fontWeight={500}>"Clients"</chakra.span> tab, we have a search bar that
          allows us to search for clients. <br />
          <br />
    ...
    },
    {
      ...
      content: (
        <Text>
          The first part of the <chakra.span fontWeight={500}>"Analytics"</chakra.span> page
          displays team statistics where agents and team leaders can compare performance to motivate
          each other.
        </Text>
      ),
    },
    {
      ...
      content: (
        <Text>
          The next section is a pie chart showing the team's success volume, categorized by bank.
          The select option in this section allows choosing a single agent or the entire team.
        </Text>
      ),
    },
    {
